...
Adapted code from the article / matlab's code `The virtual element method in 50 lines of matlab`. See [Oliver J. Sutton article](https://arxiv.org/pdf/1604.06021.pdf) and [Terence Yuyue github](https://github.com/Terenceyuyue/mVEM/tree/master/vem3) for 3D implementation.
