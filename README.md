...
Adapted code from the article / matlab's code `The virtual element method in 50 lines of matlab`. See https://arxiv.org/pdf/1604.06021.pdf and [Terence Yuyue](https://github.com/Terenceyuyue/mVEM/tree/master/vem3) for the 3D functions
