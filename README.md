...
Adapted code from the articles / matlab's codes `The virtual element method in 50 lines of matlab` and `mVEM: MATLAB Programming for Virtual Element Methods`. See [Oliver J. Sutton article](https://arxiv.org/pdf/1604.06021.pdf) and [Terence Yuyue github](https://github.com/Terenceyuyue/mVEM/tree/master/vem3) (3D implementation).
